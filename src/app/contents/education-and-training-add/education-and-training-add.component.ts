...
@Component({
  selector: 'app-education-and-training-add',
  templateUrl: './education-and-training-add.component.html',
  styleUrls: ['./education-and-training-add.component.css']
})
export class EducationAndTrainingAddComponent {
