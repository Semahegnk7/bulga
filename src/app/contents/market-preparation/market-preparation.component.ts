...
@Component({
  ...
  styleUrls: ['./market-preparation.component.css']
})
export class MarketPreparationComponent {
  ...
  displayedColumns: string[] = ['id', 'firstName','middleName', 'userName','phone','gender','department', 'actions'];
  user: any;
  id:any;
  constructor(
  ...
  getUsers() {
    this.service.getUsersByRole("MARKET_PREPARATION").subscribe((resp) => {
